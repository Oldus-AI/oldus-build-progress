...
const phases = [
  ...
  {
    id: "p-days107-132",
    title: "Days 107–132 — 2026-05-29 to 2026-06-23 (Evidence-based reconstruction)",
    status: "partial",
    items: [
      {
        id: "d107",
        title: "Day 107 — 2026-05-29",
        status: "done",
        description: "Workspace activity confirmed by commits. Ops-bridge dashboard JS fix: literal newline in .join was breaking dashboard rendering (line 955).",
        completedDate: "2026-05-29",
        subItems: [
          { text: "commit: oldus-config 3e813f1 — workspace sync: 2026-05-29 — 22 files changed, 1455 insertions", done: true },
          { text: "commit: oldus-ops 42295f8 — fix: literal newline in .join breaking dashboard JS (line 955)", done: true },
        ],
      },
      {
        id: "d108",
        title: "Day 108 — 2026-05-30",
        status: "done",
        description: "Workspace activity confirmed by commit only; no real journal entry for this date.",
        completedDate: "2026-05-30",
        subItems: [
          { text: "commit: oldus-config a10ee09 — workspace sync: 2026-05-30 — 10 files changed, 774 insertions", done: true },
        ],
      },
      {
        id: "d109",
        title: "Day 109 — 2026-05-31",
        status: "done",
        description: "Ops-bridge model tier update: upgraded default Opus tier from 4.5/4.6 to Claude Opus 4.8; 4.5 kept as opus45 alias.",
        completedDate: "2026-05-31",
        subItems: [
          { text: "commit: oldus-config 6dc0222 — workspace sync: 2026-05-31 — 10 files changed, 462 insertions", done: true },
          { text: "commit: oldus-ops 6ec4101 — bridge: opus tier -> Opus 4.8 (claude-opus-4-8); keep 4.5 as opus45", done: true },
        ],
      },
      {
        id: "d110",
        title: "Day 110 — 2026-06-01",
        status: "done",
        description: "Claude Opus 4.8 fully wired into ops-bridge pricing and MODEL_ALIASES. CardStar V2: three bug fixes shipped (Azure container name alignment, canonical docker-compose + DEPLOY.md, editor unknown-slug guard).",
        completedDate: "2026-06-01",
        subItems: [
          { text: "commit: oldus-config 0a7541d — workspace sync: 2026-06-01 — 24 files changed, 1119 insertions", done: true },
          { text: "commit: oldus-ops 5132291 — feat: add claude-opus-4-8 pricing (Opus tier)", done: true },
          { text: "commit: oldus-ops 66e6ae2 — feat: add opus-4-8 to MODEL_ALIASES and main_models", done: true },
          { text: "commit: cardstar-v2 fe35474 — fix(azure): align Vercel API container name default to cardstar-assets (#154)", done: true },
          { text: "commit: cardstar-v2 e143644 — chore(deploy): canonical docker-compose + DEPLOY.md for cardstar-server (#155)", done: true },
          { text: "commit: cardstar-v2 4eb0df2 — fix(editor): guard unknown slug — redirect to gallery, never load wrong template (#153)", done: true },
        ],
      },
      {
        id: "d111",
        title: "Day 111 — 2026-06-02",
        status: "done",
        description: "Workspace activity confirmed by commit only; no real journal entry for this date.",
        completedDate: "2026-06-02",
        subItems: [
          { text: "commit: oldus-config 58bdde2 — workspace sync: 2026-06-02 — 54 files changed, 3249 insertions", done: true },
        ],
      },
      {
        id: "d112",
        title: "Day 112 — 2026-06-03",
        status: "done",
        description: "Readymades master Systems Architecture Briefing doc fully restyled to house style (Google Doc 1_o-LQ_WUkLYTtIxkUus5OjP8dQcW74X6RpQU-x9_LyM): named styles applied (TITLE/HEADING_1/HEADING_2), near-black headings, tightened bullets, table header rows (#F0EDEB), Proxima Nova/115% line-spacing, ALL heading borders killed. Verified via PDF QA. HARD RULE established: NEVER horizontal rules under headings. Journal write-path incident investigated: 11:17 write was silently redirected to memory/ instead of oldus-journal/ — root cause traced to flush gate in OpenClaw + 03:30 active-state reset. Fix applied (session log copied to correct path).",
        completedDate: "2026-06-03",
        subItems: [
          { text: "commit: oldus-config e535994 — workspace sync: 2026-06-03 — 49 files changed, 2092 insertions", done: true },
          { text: "journal: Readymades master doc house-style restyle — named styles, killed heading borders, PDF-verified", done: true },
          { text: "journal: HARD RULE — NEVER horizontal rule/border under a heading; logged to /workspace/docs/google-docs-style-guide.md", done: true },
          { text: "journal: Journal-write incident root-caused — briefing reads JOURNAL_DIR not memory/; two state-moving mechanisms identified", done: true },
        ],
      },
      {
        id: "d113",
        title: "Day 113 — 2026-06-04",
        status: "done",
        description: "Large workspace sync (146 files, 9045 insertions) — commit-only evidence; no real journal entry for this date.",
        completedDate: "2026-06-04",
        subItems: [
          { text: "commit: oldus-config 1fed008 — workspace sync: 2026-06-04 — 146 files changed, 9045 insertions", done: true },
        ],
      },
      {
        id: "d114",
        title: "Day 114 — 2026-06-05",
        status: "done",
        description: "Ops manifest rebuilt twice: v2 reconstructs yesterday from session telemetry (not dead trace.jsonl), v3 sources from ledger so it is immune to session rotation/prune. Priority list set with James: Block Kit formatting, security-audit dedupe, sales dashboard, Shopify client-id plaintext fix, token rotations (Telegram + Slack xoxb exposed), /workspace/ literal audit.",
        completedDate: "2026-06-05",
        subItems: [
          { text: "commit: oldus-config 6295d96 — workspace sync: 2026-06-05 — 11 files changed, 449 insertions", done: true },
          { text: "commit: oldus-ops 1fea544 — manifest v2: reconstruct yesterday from session telemetry, not dead trace.jsonl", done: true },
          { text: "commit: oldus-ops 1b5befe — manifest v3: source activity from ledger, immune to session rotation/prune", done: true },
          { text: "journal: priority list agreed with James (Block Kit, security audit, sales dashboard, Shopify client-id, token rotations)", done: true },
        ],
      },
      {
        id: "d115",
        title: "Day 115 — 2026-06-06",
        status: "undocumented",
        description: "No journal entry or commit evidence for this period.",
        completedDate: "2026-06-06",
      },
      {
        id: "d116",
        title: "Day 116 — 2026-06-07",
        status: "undocumented",
        description: "No journal entry or commit evidence for this period.",
      ...
      {
        id: "d117",
        title: "Day 117 — 2026-06-08",
        status: "done",
        description: "Readymades KPI cron root-caused and fixed: refresh-readymades-kpis.py had hardcoded sandbox token path (/workspace/.google-token.json) causing every Sunday host-cron run to die with FileNotFoundError. Fixed with resolve_token_file() checking $GOOGLE_TOKEN_FILE, then script-relative path, then sandbox fallback. Verified end-to-end (28,301 source rows + 30,275 tracking rows).",
        completedDate: "2026-06-08",
        subItems: [
          { text: "commit: oldus-config da97f5e — workspace sync: 2026-06-08 — 26 files changed, 763 insertions", done: true },
          { text: "journal: Readymades KPI cron fix — resolve_token_file() added; host + sandbox paths both work; end-to-end verified", done: true },
        ],
      },
      {
        id: "d118",
        title: "Day 118 — 2026-06-09",
        status: "done",
        description: "Readymades KPI workbook deep-fix: (1) cron root cause resolved (GOOGLE_TOKEN_FILE prefix); (2) label off-by-one bug fixed — month-label cells were one month ahead of their own COUNTIFS/SUMIFS window on Data_Production + Data_Monthly; (3) Data_Production split into two tabs (one table per tab rule). Upstream data gap identified: source tracker has no orders after 28 May — genuine empty data, not a sheet bug. Comms-outage lesson logged: inline python -c wedges the turn; always invoke as a file.",
        completedDate: "2026-06-09",
        subItems: [
          { text: "commit: oldus-config e3a99f3 — workspace sync: 2026-06-09 — 5 files changed, 45 insertions", done: true },
          { text: "journal: KPI label off-by-one fixed on Data_Production + Data_Monthly", done: true },
          { text: "journal: Data_Production split — new 'Daily Production' tab (gid 928723702), Dashboard re-pointed", done: true },
          { text: "journal: upstream data gap identified — no Readymades orders after 2026-05-28 in source tracker", done: true },
        ],
      },
      {
        id: "d119",
        title: "Day 119 — 2026-06-10",
        status: "done",
        description: "Workspace activity confirmed by commit only; no real journal entry for this date.",
        completedDate: "2026-06-10",
        subItems: [
          { text: "commit: oldus-config 98813bd — workspace sync: 2026-06-10 — 9 files changed, 361 insertions", done: true },
        ],
      },
      {
        id: "d120",
        title: "Day 120 — 2026-06-11",
        status: "done",
        description: "Large workspace sync (113 files, 8690 insertions) — commit-only evidence; no real journal entry for this date.",
        completedDate: "2026-06-11",
        subItems: [
          { text: "commit: oldus-config 0371249 — workspace sync: 2026-06-11 — 113 files changed, 8690 insertions", done: true },
        ],
      },
      {
        id: "d121",
        title: "Day 121 — 2026-06-12",
        status: "done",
        description: "Workspace activity confirmed by commit only; no real journal entry for this date.",
        completedDate: "2026-06-12",
        subItems: [
          { text: "commit: oldus-config d01ebdd — workspace sync: 2026-06-12 — 9 files changed, 488 insertions", done: true },
        ],
      },
      {
        id: "d122",
        title: "Day 122 — 2026-06-13",
        status: "done",
        description: "Large workspace sync (61 files, 4557 insertions) — commit-only evidence; no real journal entry for this date.",
        completedDate: "2026-06-13",
        subItems: [
          { text: "commit: oldus-config 3f8f9e8 — workspace sync: 2026-06-13 — 61 files changed, 4557 insertions", done: true },
        ],
      },
      {
        id: "d123",
        title: "Day 123 — 2026-06-14",
        status: "done",
        description: "Workspace activity confirmed by commit only; no real journal entry for this date.",
        completedDate: "2026-06-14",
        subItems: [
          { text: "commit: oldus-config 130715d — workspace sync: 2026-06-14 — 6 files changed, 98 insertions", done: true },
        ],
      },
      {
        id: "d124",
        title: "Day 124 — 2026-06-15",
        status: "done",
        description: "Workspace activity confirmed by commit only; no real journal entry for this date.",
        completedDate: "2026-06-15",
        subItems: [
          { text: "commit: oldus-config 9c5817f — workspace sync: 2026-06-15 — 6 files changed, 99 insertions", done: true },
        ],
      },
      {
        id: "d125",
        title: "Day 125 — 2026-06-16",
        status: "done",
        description: "Vault backup taken. CAPABILITIES.md snapshotted before bootstrap trim. Workspace sync.",
        completedDate: "2026-06-16",
        subItems: [
          { text: "commit: oldus-config aa07cd4 — workspace sync: 2026-06-16 — 8 files changed, 262 insertions", done: true },
          { text: "commit: oldus-config 7117fc8 — vault backup: 2026-06-16 08:47:44", done: true },
          { text: "commit: oldus-config 0054898 — snapshot CAPABILITIES.md before bootstrap trim", done: true },
        ],
      },
      {
        id: "d126",
        title: "Day 126 — 2026-06-17",
        status: "done",
        description: "Workspace sync with significant deletions (212 deletions, 2287 insertions) — commit-only evidence; no real journal entry for this date.",
        completedDate: "2026-06-17",
        subItems: [
          { text: "commit: oldus-config b4c1cf6 — workspace sync: 2026-06-17 — 33 files changed, 2287 insertions, 212 deletions", done: true },
        ],
      },
      {
        id: "d127",
        title: "Day 127 — 2026-06-18",
        status: "done",
        description: "Large workspace sync (2894 insertions) — commit-only evidence; no real journal entry for this date.",
        completedDate: "2026-06-18",
        subItems: [
          { text: "commit: oldus-config 17ba0dc — workspace sync: 2026-06-18 — 25 files changed, 2894 insertions", done: true },
        ],
      },
      {
        id: "d128",
        title: "Day 128 — 2026-06-19",
        status: "done",
        description: "Large workspace sync (52 files, 2626 insertions) — commit-only evidence; no real journal entry for this date.",
        completedDate: "2026-06-19",
        subItems: [
          { text: "commit: oldus-config 07e9bd5 — workspace sync: 2026-06-19 — 52 files changed, 2626 insertions", done: true },
        ],
      },
      {
        id: "d129",
        title: "Day 129 — 2026-06-20",
        status: "done",
        description: "Daily briefing fully rebuilt (James directive): removed LLM from the fact path entirely. New scripts/oldus-briefing-deterministic.py — HEALTH from live ops-bridge /gateway/status, DECISIONS from MEMORY.md Blockers only, DONE YESTERDAY from .briefing-state/shipped-*.json only. Root cause of 'Gateway DOWN' false report: Haiku synthesis pass had been restating stale memory summary verbatim with no live verification. Security leak found: ops-bridge /gateway/status returns raw systemctl stdout containing unredacted GITHUB_TOKEN, ANTHROPIC_API_KEY, SLACK_BOT_TOKEN in process args. All 3 acceptance criteria passed against live state. Cron swap and alert timer deferred pending James sign-off.",
        completedDate: "2026-06-20",
        subItems: [
          { text: "commit: oldus-config bcee8fd — workspace sync: 2026-06-20 — 46 files changed, 2159 insertions", done: true },
          { text: "journal: scripts/oldus-briefing-deterministic.py built — zero LLM in fact path", done: true },
          { text: "journal: scripts/briefing-alerts.py built — event-driven P0 alerts, dedup via .briefing-state/alert-state.json", done: true },
          { text: "journal: security leak identified — ops-bridge /gateway/status leaks secrets in process args", done: true },
          { text: "journal: 3 acceptance criteria PASS against live state", done: true },
        ],
      },
      {
        id: "d130",
        title: "Day 130 — 2026-06-21",
        status: "done",
        description: "Readymades §12 closed out: coverage.json gap-list, spec housekeeping, open-items tracker, Mike package. rm-export-generalise handoff written (worker hadn't persisted it). FAS doc render-field definitions captured to Airtable + SVG safety rules to tracker. Large workspace sync (90 files, 3214 insertions).",
        completedDate: "2026-06-21",
        subItems: [
          { text: "commit: oldus-config 2b7bc89 — workspace sync: 2026-06-21 — 90 files changed, 3214 insertions", done: true },
          { text: "commit: oldus-config ee6bdae — readymades: close out §12 — coverage.json gap-list, spec housekeeping, open-items tracker, Mike package", done: true },
          { text: "commit: oldus-config 35d3619 — readymades: write rm-export-generalise handoff (worker didn't persist it); verified all 12 tables", done: true },
          { text: "commit: oldus-config 95deee2 — readymades: capture FAS doc render-field defs to Airtable + SVG safety rules to tracker", done: true },
        ],
      },
      {
        id: "d131",
        title: "Day 131 — 2026-06-22",
        status: "done",
        description: "Workspace activity confirmed by commit only; no real journal entry for this date.",
        completedDate: "2026-06-22",
        subItems: [
          { text: "commit: oldus-config 76b335e — workspace sync: 2026-06-22 — 40 files changed, 225 insertions", done: true },
        ],
      },
      {
        id: "d132",
        title: "Day 132 — 2026-06-23",
        status: "done",
        description: "Readymades Engine tab 16 (Fixings & Backing) synced into Airtable TEST base: new Fixing hardware table (tblmAuD00gspjJJ84, 6 production codes SDR/DDR/BCL/SCL/STD/SCR), strutbacks selling_gbp set, fixing choices security uplift corrected £5→£4. Briefing cron env fixed (SLACK_BOT_TOKEN was sourced from wrong env file). Briefing direction decision: drop health/KPI stats, focus on completed work + today's priorities. Catherine weekly signups export: scripts/weekly-signups-export.py built and run — W25 sheet created (1,737 sign-ups, 212 with UTM). Readymades TEST base U·/STD·/CUS· restructure verified live against all 27 tables. U· SKU registry populated: 889 rows from 9 component tables (frames 348, products 316, sizes 82, mouldings 78, mounts 25, strutbacks 21, substrates 7, fixings 6, glaze 6), then 891 after SAMF + SAMM samples added. Field consolidation analysis on U· Mouldings: legacy (mm) columns safe to delete (100% match with snake_case, referenced by nothing).",
        completedDate: "2026-06-23",
        subItems: [
          { text: "commit: oldus-config 2917b2b — workspace sync: 2026-06-23 — 38 files changed, 2402 insertions", done: true },
          { text: "journal: Readymades Airtable — Engine tab 16 synced; Fixing hardware table created; strutbacks + fixing costs corrected", done: true },
          { text: "journal: briefing cron fixed — SLACK_BOT_TOKEN sourced from correct env file", done: true },
          { text: "journal: briefing direction reset — health/KPI dropped; focus = completed work + priorities", done: true },
          { text: "journal: weekly-signups-export.py built + run; W25 sheet shipped to Catherine (1,737 rows)", done: true },
          { text: "journal: U·/STD·/CUS· restructure verified live — 27 tables, pricing_model field intact, 3 links wired", done: true },
          { text: "journal: U· SKU registry populated — 891 rows (889 + SAMF + SAMM); FLO collision resolved; field consolidation analysed", done: true },
        ],
      },
    ],
  },
